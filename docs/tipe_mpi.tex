...
{\huge\bfseries\centering CODES CORRECTEURS DE DONNÉES ET JEUX
\newline
\par}
...
\centering
\includegraphics[width=6.5cm]{/home/triplaqs/Documents/MPI/TIPE/Img/coco.jpg}
\end{column}

\begin{column}{0.35\textwidth}
\centering
\includegraphics[width=3.5cm]{/home/triplaqs/Documents/MPI/TIPE/Img/cdrom2.png}
\end{column}
...
\centering
\includegraphics[width=2.5cm]{/home/triplaqs/Documents/MPI/TIPE/Img/takuzuex.png}
...
\begin{itemize}
\item Commencer par une transformation manuelle sur des petites séquences, afin de pouvoir exploiter l'idée.
...
Puis conversion en grilles de Takuzu manuellement. Le choix a été fait d'utiliser une séquence d'information le permettant avant de s'attaquer à plus générique (\emph{a priori} impossible).
\newline
...
Code C, code qui vérifie les 3 conditions du Takuzu (fonctionnel).
Code qui vérifie si et combien de pertes ont eu lieu (fonctionnel, pertes implémentées à -1).
Code de résolution (fonctionnel).
\end{column}

\begin{column}{0.08\textwidth}
\centering
\includegraphics[width=1.5cm]{/home/triplaqs/Documents/MPI/TIPE/Img/test1.png}
\end{column}

\begin{column}{0.08\textwidth}
\centering
\includegraphics[width=1.5cm]{/home/triplaqs/Documents/MPI/TIPE/Img/test2.png}
\end{column}

\begin{column}{0.08\textwidth}
\centering
\includegraphics[width=1.5cm]{/home/triplaqs/Documents/MPI/TIPE/Img/test3bis3edit.png}
\end{column}
...
\end{itemize}
Attente de l'étude des algoritmes de backtracking afin de l'implémenter en C couplé avec les autres fonctions.
...
\begin{frame}
\centering
{\huge\bfseries EXEMPLES DE RÉSOLUTION
\newline
\par}
...
\centering
\includegraphics[width=3.5cm]{/home/triplaqs/Documents/MPI/TIPE/Img/reso1.png}
\end{column}

\begin{column}{0.5\textwidth}
\centering
\includegraphics[width=3.5cm]{/home/triplaqs/Documents/MPI/TIPE/Img/reso2.png}
\end{column}
