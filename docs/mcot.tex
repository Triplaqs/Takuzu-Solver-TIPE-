...
\subsection*{Ancrage}
\begin{frame}
\frametitle{ANCRAGE AU SUJET}
\begin{itemize}
\item le raccrochage au Thème "Sports et Jeux" se fait par l'utilisation d'un jeu (le Takuzu, ou plus communément Binairo), pour que des contraintes viennent substituer la redondance dans la correction de données.
\end{itemize}
\end{frame}
